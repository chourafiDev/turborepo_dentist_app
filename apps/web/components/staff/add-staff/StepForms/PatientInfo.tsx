...
import { TStaffFirstFormSchema, staffFirstFormSchema } from "@/lib/validation";
...
const PatientInfo = () => {
  ...
  const form = useForm<TStaffFirstFormSchema>({
    resolver: zodResolver(staffFirstFormSchema),
    defaultValues: {
      ...formData,
    },
  });

  function onSubmit(values: TStaffFirstFormSchema) {
    setCurrentStep("inc");
